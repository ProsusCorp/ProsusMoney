...
public:
  ...
  //ykb size_t blockGrantedFullRewardZoneByBlockVersion(uint8_t blockMajorVersion, uint32_t height) const;
  ...
  bool getBlockReward(uint8_t blockMajorVersion, size_t medianSize, size_t currentBlockSize, uint64_t alreadyGeneratedCoins, uint64_t fee,
    uint64_t& reward, int64_t& emissionChange, uint64_t height) const; //ykb
