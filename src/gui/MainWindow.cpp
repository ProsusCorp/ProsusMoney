...
void MainWindow::initUi() {
  setWindowTitle(QString(tr("Prosus_Money Wallet %1")).arg(Settings::instance().getVersion()));
#ifdef Q_OS_WIN32
  createTrayIcon();
#endif
...
//  QMessageBox::information(nullptr, QObject::tr("Help"), cmdLineParser.getHelpText());
    QMessageBox *msg = new QMessageBox(QMessageBox::Information, QObject::tr("Help"),
                       ...
                       QMessageBox::Ok, this);
    msg->setInformativeText(tr("More info can be found at https://prosus.money"));
...
void MainWindow::createTrayIcon()
{
    ...
    QString toolTip = QString(tr("Prosus_Money Wallet %1")).arg(Settings::instance().getVersion());
