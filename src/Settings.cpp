...
// Copyleft (c) 2016-2021, Prosus Corp RTD
...
void Settings::load() {
  ...
  defaultPoolList << "pool.prosus.money:16185";
  ...
  defaultNodesList << "seed01.prosus.money:16181" << "seed02.prosus.money:16181" << "seed03.prosus.money:16181" << "seed04.prosus.money:16181" ;
...
QString Settings::getCurrentRemoteNode() const {
    ...
    if (m_settings.contains(OPTION_REMOTE_NODE)) {
        ...
        remotenode = "seed01.prosus.money:16181";
	}
    return remotenode;
}
